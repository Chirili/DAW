...
* [6. Consultas SELECT(II)](#Consultas-SELECT-II)
  ...
  * [6.6 ¿Qué devuelve la siguiente consulta? Razona tu respuesta.](#Qué-devuelve-la-siguiente-consulta)
...
#### Inserta para el día 10-JUL-2019 los mismo vuelos del día 10-FEB-2018 pero con una ocupación inicial de 0 pasajeros
...
#### Crear una vista actualizable llamada RUTA_LARGA que contenga aquellas rutas cuya duración sea igual o mayor a 2 horas
